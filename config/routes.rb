Galleygrab::Application.routes.draw do
	resources :users
  resource :session
  
  resources :site_reviews
  resources :covers
  resources :orders, :has_many => :site_reviews

  resources :books
  
  root :to => "orders#welcome"
  match '/confirmation/:id', :to => 'orders#confirmation'
  match '/catalog', :to => 'orders#catalog'
	match '/cart', :to => 'orders#cart_filled' 
	...
	namespace :admin do 
  	...
  	resources :site_reviews
  	resources :home
  	match '/counts', :to => 'home#counts'
  	match '/data_export_form', :to =>'home#data_export_form'
  	match 'data_export', :to =>'home#data_export'
  	root :to => 'home#index'
	end
...
# 
# 
# Galleygrab::Application.routes.draw do |map|
#   
# 	map.resources :users
